...
const ELEMENT_TAGS = {
    ...
    TD: (el) => ({ type: 'td', attrs: {} }),
    TH: (el) => ({ type: 'th', attrs: {} }),
    FIGURE: (el) => ({ type: 'reference', attrs: { default: true, "display-type": "display" } }),
    SPAN: (el) => {
...
const fromRedactor = (el, allowExtraTags) => {
    ...
    if (el.nodeName === 'BODY') {
        if (el.childNodes.length === 1 && el.childNodes[0].nodeType === 3) {
            return slate_hyperscript_1.jsx('fragment', {}, [{ type: 'p', attrs: {}, uid: generateId(), children: [{ text: el.childNodes[0].textContent }] }]);
        }
        if (el.childNodes.length === 0) {
            return slate_hyperscript_1.jsx('fragment', {}, [{ type: 'p', attrs: {}, children: [{ text: '' }], uid: generateId() }]);
        }
        return slate_hyperscript_1.jsx('fragment', {}, children);
    }
