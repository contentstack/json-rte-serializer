...
const generateId = () => uuid_1.v4().split('-').join('');
...
const traverseChildAndModifyChild = (element, attrsForChild) => {
    ...
    if (element.hasOwnProperty('text')) {
        let attrsForChildCopy = lodash_1.cloneDeep(attrsForChild);
...
const traverseChildAndWarpChild = (children) => {
    ...
    let childrenCopy = lodash_1.cloneDeep(children);
    Array.from(children).forEach((child, index) => {
        ...
        if (child.hasOwnProperty('type')) {
            ...
            childrenCopy[index] = slate_hyperscript_1.jsx("text", {}, child);
            inlineElementIndex.push(index);
        }
    });
    if (hasBlockElement && !lodash_1.isEmpty(inlineElementIndex)) {
...
const fromRedactor = (el, allowExtraTags) => {
    ...
    if (el.nodeType === 3) {
        ...
        if (el.parentNode.nodeName === 'SPAN') {
            ...
            return slate_hyperscript_1.jsx('text', { attrs: attrs }, el.textContent);
        }
    ...
    const { nodeName } = el;
    let parent = el;
    let children = lodash_1.flatten(Array.from(parent.childNodes).map((child) => exports.fromRedactor(child, allowExtraTags)));
    ...
    if (el.nodeName === 'BODY') {
        if (el.childNodes.length === 1 && el.childNodes[0].nodeType === 3) {
            return slate_hyperscript_1.jsx('element', { type: "doc", uid: generateId(), attrs: {} }, [{ type: 'p', attrs: {}, uid: generateId(), children: [{ text: el.childNodes[0].textContent }] }]);
        }
        if (el.childNodes.length === 0) {
            return slate_hyperscript_1.jsx('element', { type: "doc", uid: generateId(), attrs: {} }, [{ type: 'p', attrs: {}, children: [{ text: '' }], uid: generateId() }]);
        }
        return slate_hyperscript_1.jsx('element', { type: "doc", uid: generateId(), attrs: {} }, children);
    }
        ...
        if (entryUid && contentTypeUid && displayType && locale) {
            ...
            if (el.style) {
                ...
                Array.from({ length: el.style.length }).forEach((child, index) => {
                    ...
                    allStyleAttrs[lodash_1.kebabCase(property)] = el.style.getPropertyValue(property);
                });
                elementAttrs = {
                    ...elementAttrs,
            ...
            return slate_hyperscript_1.jsx('element', { attrs: { ...elementAttrs === null || elementAttrs === void 0 ? void 0 : elementAttrs.attrs, "type": type, "entry-uid": entryUid, "content-type-uid": contentTypeUid, "display-type": displayType, locale }, type: "reference", uid: generateId() }, children);
        }
    }
    ...
    if (isEmbedAsset && type === "asset") {
        ...
        if (fileLink && uid && fileName && contentType) {
            ...
            elementAttrs.attrs["redactor-attributes"] = redactor;
            return slate_hyperscript_1.jsx('element', { attrs: { ...elementAttrs === null || elementAttrs === void 0 ? void 0 : elementAttrs.attrs, type, "asset-caption": caption, "link": link, "asset-alt": alt, target, position, "asset-link": fileLink, "asset-uid": uid, "display-type": displayType, "asset-name": fileName, "asset-type": contentType, "content-type-uid": contentTypeUid }, type: "reference", uid: generateId() }, children);
        }
    }
    ...
    if (nodeName === 'DIV') {
        ...
        if (dataType === 'row') {
            ...
            return slate_hyperscript_1.jsx('element', attrs, children);
        }
        if (dataType === 'column') {
        ...
        if (dataType === 'hr') {
            return slate_hyperscript_1.jsx('element', {
                type: 'hr',
                uid: generateId()
            }, [
                {
    ...
    if (ELEMENT_TAGS[nodeName]) {
        ...
        if (nodeName === 'FIGURE') {
            ...
            return slate_hyperscript_1.jsx('element', elementAttrs, [{ text: '' }]);
        }
        if (nodeName === 'A') {
            let newChildren = children.filter(trimChildString);
        ...
        if (nodeName === 'SPAN') {
            if (((_30 = (_29 = elementAttrs === null || elementAttrs === void 0 ? void 0 : elementAttrs.attrs) === null || _29 === void 0 ? void 0 : _29["redactor-attributes"]) === null || _30 === void 0 ? void 0 : _30['data-type']) === 'inlineCode') {
                ...
                return children.map((child) => slate_hyperscript_1.jsx('text', attrsStyle, child));
            }
        ...
        return slate_hyperscript_1.jsx('element', elementAttrs, children);
    }
    if (TEXT_TAGS[nodeName]) {
        ...
        let newChildren = children.map((child) => {
            if (lodash_1.isObject(child)) {
                traverseChildAndModifyChild(child, attrsStyle);
                //console.log("child", child)
                return child;
            }
            else {
                return slate_hyperscript_1.jsx('text', attrsStyle, child);
            }
        });
        return slate_hyperscript_1.jsx('fragment', {}, newChildren);
    }
    if (children.length === 0) {
        children = [{ text: '' }];
    }
...
const getImageAttributes = (elementAttrs, childAttrs, extraAttrs) => {
    ...
    if (lodash_1.isUndefined(elementAttrs.attrs["asset-caption"])) {
        delete elementAttrs.attrs["asset-caption"];
    }
    if (lodash_1.isUndefined(elementAttrs.attrs["link"])) {
