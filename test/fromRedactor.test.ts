...
describe("Testing html to json conversion", () => {
    ...
    test("should convert social embed to proper social embed json", () => {
        let html = `<iframe src="***REMOVED***" data-type="social-embeds"></iframe>`
        const json = htmlToJson(html)
        expect(json).toEqual({ type: "doc", attrs: {}, uid: "uid", children:[{ type: "social-embeds", uid: 'uid', attrs: { src: "***REMOVED***" }, children: [{ text: ""}] }]})
    })
})
